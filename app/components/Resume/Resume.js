...
const Resume = () => {
  return (
    <div className="w-full h-[32rem] bg-[#29BF12] background flex justify-center items-center">
      <div className="flex justify-center gap-8 items-center flex-col ">
        <h1 className="font-abril pt-20 text-8xl max-xl:text-6xl max-md:text-4xl max-sm:text-2xl max-[300px]:text-xl">
          Design Stuff* for &nbsp;
          <span className="relative">
            <span className="font-abril absolute -top-14 max-xl:-top-10 max-md:-top-6 max-[300px]:-top-4">Human</span>
